...
export class Init1783439657332 implements MigrationInterface {
  name = 'Init1783439657332';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "act_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f700490e5f854f8597d4aaa95b4" UNIQUE ("name"), CONSTRAINT "PK_e4c7330796a6f6784b9acdddd15" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
